...
import type { I${Name}DatabasePort } from '../ports/outbound/${Name}DatabasePort';
 ...
 * Depends on I${Name}DatabasePort (outbound) — injected via constructor shorthand.
 */
export class ${Name}UseCase implements I${Name}Port {
  constructor(private readonly db: I${Name}DatabasePort) {}
