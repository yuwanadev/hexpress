...
function resolvePaths(root, type, scopeName, featureName, flags = {}) {
  ...
  return {
    ...
    outboundPort: path.join(base, 'application', 'ports', 'outbound', `${Name}${Suffix}.js`),
    ...
    repository:   path.join(base, 'infrastructure', 'adapters', 'outbound', flags.outboundAdapter || 'persistence', `${Name}Repository.js`),
